...
def do_train(args, cfg):
    ...
    source_loader = instantiate(cfg.source_dataloader.train)
    target_loader = instantiate(cfg.target_dataloader.train)
    val_loader = instantiate(cfg.source_dataloader.test)

    model = create_ddp_model(model, **cfg.train.ddp)
    trainer = DATrainer(model, source_loader, target_loader, optim)
...
def register_dataset():
    ...
    register_coco_instances("maize_syn_v2_train", {},
                            "/opt/datasets/Corn_syn_dataset/maize_syn_v3/instances_train_2022.json",
                            "/opt/datasets/Corn_syn_dataset/maize_syn_v3/data")
    register_coco_instances("maize_real_v2_val", {},
                            "/opt/datasets/Corn_syn_dataset/2022_GIL_Paper_Dataset_V2/coco_anns/instances_val_2022.json",
                            "/opt/datasets/Corn_syn_dataset/GIL_dataset/all_days/data")
